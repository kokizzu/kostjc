...
var viewList = map[string]string{
	...
	`Room`:            `../svelte/room.html`,            // ../svelte/room.svelte
	`Stock`:           `../svelte/stock.html`,           // ../svelte/stock.svelte
	`Tenants`:         `../svelte/tenants.html`,         // ../svelte/tenants.svelte
	`User`:            `../svelte/user.html`,            // ../svelte/user.svelte
	`UsersManagement`: `../svelte/usersManagement.html`, // ../svelte/usersManagement.svelte
}
...
func (v *Views) RenderRoom(c *fiber.Ctx, m M.SX) error {
	c.Set("Content-Type", "text/html; charset=utf-8")
	return c.SendString(v.cache[`Room`].Str(m))
}
...
func (v *Views) RenderTenants(c *fiber.Ctx, m M.SX) error {
	c.Set("Content-Type", "text/html; charset=utf-8")
	return c.SendString(v.cache[`Tenants`].Str(m))
}
...
func (v *Views) RenderUsersManagement(c *fiber.Ctx, m M.SX) error {
	c.Set("Content-Type", "text/html; charset=utf-8")
	return c.SendString(v.cache[`UsersManagement`].Str(m))
}
