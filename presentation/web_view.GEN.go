...
var viewList = map[string]string{
	...
	`UserReport`:           `../svelte/userReport.html`,           // ../svelte/userReport.svelte
}
...
func (v *Views) RenderUserReport(c *fiber.Ctx, m M.SX) error {
	c.Set("Content-Type", "text/html; charset=utf-8")
	return c.SendString(v.cache[`UserReport`].Str(m))
}
