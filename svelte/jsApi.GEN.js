...
/**
 * @typedef {Object} StaffOccupancyHeatmapIn
 * @property {String} yearMonth
 */
const StaffOccupancyHeatmapIn = {
  yearMonth: '', // string
}
/**
 * @typedef {Object} StaffOccupancyHeatmapOut
 * @property {number} user.id
 * @property {String} user.email
 * @property {String} user.password
 * @property {number} user.createdAt
 ...
 * @property {Object} bookings
 */
const StaffOccupancyHeatmapOut = {
  user: { // rqAuth.Users
    id: 0, // uint64
    email: '', // string
    password: '', // string
  ...
  roomNames: [], // []string
  bookings: { // []rqProperty.BookingDetailPerMonth
  }, // []rqProperty.BookingDetailPerMonth
}
/**
 * @callback StaffOccupancyHeatmapCallback
 * @param {StaffOccupancyHeatmapOut} o
 * @returns {Promise}
 */
/**
 * @param  {StaffOccupancyHeatmapIn} i
 * @param {StaffOccupancyHeatmapCallback} cb
 * @returns {Promise}
 */
exports.StaffOccupancyHeatmap = async function StaffOccupancyHeatmap( i, cb ) {
  return await axios.post( '/staff/occupancyHeatmap', i ).
    then( wrapOk( cb ) ).
    catch( wrapErr( cb ) )
}
